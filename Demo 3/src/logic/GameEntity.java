...
public class GameEntity { // By default a physically "static" object
    ...
    if(x < 0){
      new SafeCrash("Error: invalid value.", "X-coordinate cannot be negative." "Logic, GameEntity, SetX");
    }
		this.x = x;
	}
    ...
    if(y < 0){
      new SafeCrash("Error: invalid value.", "Y-coordinate cannot be negative." "Logic, GameEntity, SetY");
    }
		this.y = y;
	}
