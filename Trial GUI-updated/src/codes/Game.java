	...
	public void handle(KeyEvent key) {
		...
		switch (key.getCode()) {
			...
			case RIGHT:
				...
				break;
			case ENTER:
				if(tanks.get(0).getShooting() == false){
					shoot(tanks.get(0));
					tanks.get(0).setShooting(true);
				}
				break;
			case W:
			...
			case D:
				...
				break;
			case Q:
				if(tanks.get(1).getShooting() == false){
					shoot(tanks.get(1));
					tanks.get(1).setShooting(true);
				}
				break;
